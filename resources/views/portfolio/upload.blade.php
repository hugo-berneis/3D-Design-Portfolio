...
@section('content')
    <div class="max-w-[600px] mx-auto py-12 px-8">
        ...
        <form action="{{ route('models.store') }}" method="POST" enctype="multipart/form-data"
            class="bg-neutral-900 p-8 rounded-sm border border-neutral-800">
            @csrf
            ...
            <div class="mb-6">
                ...
                <select name="design_id" id="design_id" required
                    class="w-full p-3 bg-neutral-800 text-neutral-200 border border-neutral-700 rounded-sm text-base">
            ...
            <div class="mb-8">
                ...
                <input type="file" name="model_file" id="model_file" accept=".stl" required
                    class="w-full p-3 bg-neutral-800 text-neutral-200 border border-neutral-700 rounded-sm">
                <p class="text-sm text-neutral-400 mt-2">Maximum file size: 100MB. Supported format: .STL</p>
            </div>

            <button type="submit"
                class="w-full p-3 bg-white text-neutral-950 border-none rounded-sm font-semibold cursor-pointer text-base transition-colors duration-200 hover:bg-neutral-200">
                Upload Model
            </button>
        </form>
