...
@section('content')
    ...
    <section class="flex gap-3 p-8 justify-center flex-wrap max-w-[1400px] mx-auto border-b border-neutral-200 dark:border-neutral-800"
        id="portfolio">
            ...
            <div
                ...
                <div class="p-6">
                    <div
                        ...
                        {{ $design->category }}</div>
                    <h3 class="text-base font-semibold mb-2 text-neutral-900 dark:text-white tracking-wide">{{ $design->title }}</h3>
                    <p class="text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed mb-4">{{ Str::limit($design->description, 100) }}
                    </p>
