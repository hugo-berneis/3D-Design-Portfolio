...
Route::get('/models', [PortfolioController::class, 'index'])->name('portfolio.index');
Route::get('/models/{design}', [PortfolioController::class, 'show'])->name('portfolio.show');
Route::post('/models/{design}/rotation', [PortfolioController::class, 'updateRotation'])->name('portfolio.update-rotation');
Route::get('/models/category/{category}', [PortfolioController::class, 'category'])->name('portfolio.category');
